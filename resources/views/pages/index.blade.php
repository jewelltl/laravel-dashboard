					...
					<div class="portfolio-items">
						...
						<div class="col-md-4 col-sm-6 work-grid wordpress graphic">
							<div class="portfolio-content">
								...
								<div class="portfolio-overlay">
									<a href="{{(Auth::check())? URL:: asset('images/works/portfolio-1.jpg'): URL::route('login')}}"><i class="fa fa-camera-retro"></i></a>
						...
						<div class="col-md-4 col-sm-6 work-grid html php bootstrap">
							<div class="portfolio-content">
								...
								<div class="portfolio-overlay">
									<a href="{{(Auth::check())? URL:: asset('images/works/portfolio-2.jpg'): URL::route('login')}}"><i class="fa fa-camera-retro"></i></a>
									<h5>Web Development</h5>
									<p>Design, Develop</p>
								</div>
							</div>	
						...
						<div class="col-md-4 col-sm-6 work-grid wordpress graphic">
							<div class="portfolio-content">
								...
								<div class="portfolio-overlay">
									<a href="{{(Auth::check())? URL:: asset('images/works/portfolio-3.jpg'): URL::route('login')}}"><i class="fa fa-camera-retro"></i></a>
									<h5>Web Development</h5>
									<p>Design, Develop</p>
								</div>
							</div>	
						...
						<div class="col-md-4 col-sm-6 work-grid html php bootstrap">
							<div class="portfolio-content">
								...
								<div class="portfolio-overlay">
									<a href="{{(Auth::check())? URL:: asset('images/works/portfolio-4.jpg'): URL::route('login')}}"><i class="fa fa-camera-retro"></i></a>
									<h5>Web Development</h5>
									<p>Design, Develop</p>
								</div>
							</div>	
						...
						<div class="col-md-4 col-sm-6 work-grid wordpress graphic php">
							<div class="portfolio-content">
								...
								<div class="portfolio-overlay">
									<a href="{{(Auth::check())? URL:: asset('images/works/portfolio-5.jpg'): URL::route('login')}}"><i class="fa fa-camera-retro"></i></a>
									<h5>Web Development</h5>
									<p>Design, Develop</p>
								</div>
							</div>	
						...
						<div class="col-md-4 col-sm-6 work-grid html bootstrap graphic">
							<div class="portfolio-content">
								...
								<div class="portfolio-overlay">
									<a href="{{(Auth::check())? URL:: asset('images/works/portfolio-6.jpg'): URL::route('login')}}"><i class="fa fa-camera-retro"></i></a>
									<h5>Web Development</h5>
									<p>Design, Develop</p>
								</div>
							</div>	
